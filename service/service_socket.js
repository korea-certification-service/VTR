    ...
    */
    ...
    socket.on("trade", function(data) {
      ...
      if (data.who === data.sellerTag) { 
        ...
        if (data.command === 1 || data.command === 1.1 || data.command === 3 || data.command === 3.1 || data.command === 15 || data.command === 15.1) {
        ...
        if (data.command === 2 || data.command === 2.1|| data.command === 4 || data.command === 4.1 || data.command === 15 || data.command === 15.1) {
